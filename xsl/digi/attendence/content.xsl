...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
								...
								if(question){
									...
									$.hori.ajax({
										...
										function createAttendencTable(){
											...
											var jsondata = '{"head": [{"title":"日期","dataid":"column1"},{"title":"最早打卡时间","dataid":"column2"},{"title":"最晚打卡时间","dataid":"column3"},{"title":"类型","dataid":"column4"},{"title":"需请假(小时)","dataid":"column6"},{"title":"需请假(天)","dataid":"column7"},{"title":"抵消类别","dataid":"column8"},{"title":"实际开始时间","dataid":"column11"},{"title":"实际结束时间","dataid":"column12"},{"title":"备注","dataid":"column13"}],"data": ';
	...
	<xsl:template match="fieldentry">
			...
			<input type="hidden" id="{@id}" name="{@id}" value="{value/.}" />			
				...
				<li data-role="list-divider">补考勤明细</li>
