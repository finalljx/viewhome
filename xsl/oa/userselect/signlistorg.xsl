...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="viewentry">
		<li>
			<a name="signListUser" href="javascript:userselect('/view/oa/userselect/doctest/indishare/addresstree.nsf/vwdepbyparentcode?readviewentries&amp;count=10000&amp;startkey={entrydata[2]/text/text()}&amp;UntilKey={entrydata[2]/text/text()}0&amp;data-userstore=')" data-dom-cache="true" style="text-align:left;">
				<xsl:if test="not(entrydata[3]/text/text()='1')">
					<xsl:attribute name="href">javascript:userselect('/view/oa/userselectuser/doctest/indishare/addresstree.nsf/vwUserBydepPath?readviewentries&amp;restricttocategory=_<xsl:value-of select="entrydata[2]/text/text()"/>_&amp;count=500&amp;start=1&amp;data-userstore=')</xsl:attribute>
				</xsl:if>
