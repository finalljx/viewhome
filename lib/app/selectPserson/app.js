...
function sure(){
	...
	if(persons.length == 0){
	 ...
	 localStorage.setItem("oaNextNodeId",p1);
...
function postToNextNode(optpsnid, tempauthors){
	...
	var toNodeId = "FlowNode2";
	var CurUserITCode="";
	if (localStorage.getItem("oaNextNodeId")){
		CurUserITCode = localStorage.getItem("oaNextNodeId");
