...
function searchContact(){
	...
	soap+='<web:searchUser>'+'<arg0>'+currentUser+'</arg0>'+'<arg1>'+encodeURI(searchStr)+'</arg1>'+'<arg2>'+currentPage+'</arg2>'+'<arg3>'+pageSize+'</arg3>'+'</web:searchUser>';
	soap+="</soapenv:Body></soapenv:Envelope>";
	/*var soap ='$lt;soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:urn="urn:DefaultNamespace" xmlns:web="http://webService.contant.com/"$gt;';
	soap+='$lt;soapenv:Header$gt;$lt;/soapenv:Header$gt; $lt;soapenv:Body$gt;';
	soap+='$lt;web:searchUser$gt;'+'$lt;arg0$gt;'+currentUser+'$lt;/arg0$gt;'+'$lt;arg1$gt;'+searchStr+'$lt;/arg1$gt;'+'$lt;arg2$gt;'+currentPage+'$lt;/arg2$gt;'+'$lt;arg3$gt;'+pageSize+'$lt;/arg3$gt;'+'$lt;/web:searchUser$gt;';
	soap+="$lt;/soapenv:Body$gt;$lt;/soapenv:Envelope$gt;";*/
