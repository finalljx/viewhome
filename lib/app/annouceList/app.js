...
function getStarNumber(){
	var url = 
	serverUrl+'view/oamobile/annoucementstarnumber/Application/DigiFlowInfoPublish.nsf/InfoByDateView?readviewentries';
	$.hori.ajax({
		"type":"get",
		"url":url,
		"success":function(res){
		 starNumber=parseInt(res);
		 getAnnouceList();
...
function pullUpAction(){
	$.hori.showLoading();
	endNumber = parseInt($("a").attr("data-endNumber"))+1;
