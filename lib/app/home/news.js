...
function render(jsonData,type) {
	...
	case "GT_HomePage_SiteArea_jttz":
		...
		$('#jttzList').prepend('<li data-role="list-divider" role="heading" class="ui-li ui-li-divider ui-bar-b ui-first-child"><a class="ui-link">通知公告</a> <a href="#" style="float: right" class="ui-link">more</a></li>');
		break;
	case "GT_HomePage_SiteArea_jtxw":
		ko.applyBindings(viewModel,document.getElementById("jtxwList"));
		$('#jtxwList').prepend('<li data-role="list-divider" role="heading" class="ui-li ui-li-divider ui-bar-b ui-first-child"><a class="ui-link">集团新闻</a> <a href="#" style="float: right" class="ui-link">more</a></li>');
		break;
	case "GT_HomePage_SiteArea_zgsxw":
		ko.applyBindings(viewModel,document.getElementById("cydwxwList"));
		$('#cydwxwList').prepend('<li data-role="list-divider" role="heading" class="ui-li ui-li-divider ui-bar-b ui-first-child"><a class="ui-link">成员单位新闻</a> <a href="#" style="float: right" class="ui-link">more</a></li>');
		break;
	}
}
