...
function render(jsonData,type) {
	...
	case "GT_HomePage_SiteArea_jttz":
		...
		$('#jttzList').prepend('<li data-role="list-divider" role="heading" class="ui-li ui-li-divider ui-bar-b ui-first-child"><a class="ui-link">集团通知</a> <a href="#" style="float: right" class="ui-link" onclick="loadNewsList(\'' + type + '\');">more</a></li>');
		break;
