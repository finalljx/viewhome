						...
						"success" : function(res) {
							...
							if (page == 1) {
								...
								localStorage.setItem("currentContentName",
										jsonData.list[0].contentName);// 存入第一个列表的ID
								// 加载pad右侧页面详情
...
function render() {
	...
	$('#querydataList')
			.append(
					'<li id="moredata" class="ui-li-static ui-body-inherit ui-last-child"><div id="pullUp" align="center"><span class="pullUpLabel">上拉加载更多...</span></div></li>');
	loaded();
}
