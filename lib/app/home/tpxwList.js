...
//							},
							"success" : function(res) {
								...
								for ( var item in list) {
									list[item].tpxwImage = list[item].tpxwImage.substring(list[item].tpxwImage.indexOf(".cn")+3);
									var targetURL = $.hori.getconfig().appServerHost2
											+ 'view/tpxw/file'
											+ list[item].tpxwImage
											+ "?data-result=file&data-application=" + $.hori.getconfig().appKey + "&data-thumb=200";;
