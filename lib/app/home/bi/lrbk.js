...
function loadLrbkChart() {
	...
	$.hori.ajax({
		...
		"success" : function(res) {
			...
			$("#rightContent").load("bi/lrbk.html", function(a, b, c) {
				$.hori.hideLoading();
				...
				document.getElementById("36").style.backgroundColor = '#5e87b0';
			});
...
function loadlrbk(title, year, month, primaryunit, category, seriesdata) {
	var option = {
		...
		color : [ '#e40218', '#fdf001', '#b5c606', '#32cd32', '#76c7c0', '#1596ab', '#e98434', '#409736', '#ff6600',
