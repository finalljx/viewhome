										...
										for (var i = 0; i < busiData.length; i++) {
											...
											if (busiName != '证券投资') {
												if (30 == busiData[i].now) {
													imgString = imgString
															+ "<li style='line-height:50px;'><div style='float:left;clear:both;width:"
															+ imgStringWidth
															+ ";min-width:65px;'>"
															+ busiName
												...
												for (var j = 0; j < imageType.length - 1; j++) {
													if (10 == imageType[j]) {
														imgString = imgString
																+ "<div style='float:left;margin-top:8px; width:36px;'><img src='../html/bi/img/xiaolv.png' width="
																+ tbImgWidth
																+ " class='small_light'/></div>";
													} else if (20 == imageType[j]) {
														imgString = imgString
																+ "<div style='float:left; margin-top:8px; width:36px;'><img src='../html/bi/img/xiaohuang.png' width="
																+ tbImgWidth
																+ " class='small_light'/></div>";
													} else if (30 == imageType[j]) {
														imgString = imgString
																+ "<div style='float:left; margin-top:8px; width:36px;'><img src='../html/bi/img/xiaohong.png' width="
																+ tbImgWidth
																+ " class='small_light'/></div>";
													} else {
														imgString = imgString
																+ "<div style='float:left;margin-top:8px; width:36px;'><img src='../html/bi/img/xiaohui.png' width="
																+ tbImgWidth
																+ " class='small_light'/></div>";
													}
												}
	...
	if (year == currentYear) {
		if (monthdata[0] == '1月') {
			...
			if (targetMonth) {
				...
				a = (11 - index) * parseInt(a) + x;// alert('2:
