					...
					$("#rightContent")
							.load(
									...
									function(a, b, c) {
										...
										console.log('imgString1==' + imgString);
										...
										for (var i = 0; i < busiData.length; i++) {
											...
											if (30 == busiData[i].now) {
												imgString = imgString
														...
														+ ";min-width:65px;'>"
														+ busiName
														+ "</div><div style='float:left;'><img src='../html/bi/img/dahong.png'  width="
														+ imgwidth
														+ " class='big_light'/></div>"
											} else {
												imgString = imgString
														...
														+ ";min-width:65px;'>"
														+ busiName
														+ "</div><div style='float:left;'><img src='../html/bi/img/dalv.png'  width="
														+ imgwidth
														+ " class='big_light'/></div>"
											}
											...
											for (var j = 0; j < imageType.length - 1; j++) {
												if (10 == imageType[j]) {
													imgString = imgString
															+ "<div style='float:left;margin-top:8px; width:29px;'><img src='../html/bi/img/xiaolv.png' width="
															+ tbImgWidth
															+ " class='small_light'/></div>";
												} else if (20 == imageType[j]) {
													imgString = imgString
															+ "<div style='float:left; margin-top:8px; width:29px;'><img src='../html/bi/img/xiaohuang.png' width="
															+ tbImgWidth
															+ " class='small_light'/></div>";
												} else if (30 == imageType[j]) {
													imgString = imgString
															+ "<div style='float:left; margin-top:8px; width:29px;'><img src='../html/bi/img/xiaohong.png' width="
															+ tbImgWidth
															+ " class='small_light'/></div>";
												} else {
													imgString = imgString
															+ "<div style='float:left;margin-top:8px; width:29px;'><img src='../html/bi/img/xiaohui.png' width="
															+ tbImgWidth
															+ " class='small_light'/></div>";
												}
											}
