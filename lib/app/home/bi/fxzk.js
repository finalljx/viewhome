											...
											for (var i = 0; i < busiData.length; i++) {
												...
												if (busiName != '证券投资') {
													...
													for (var j = 0; j < imageType.length - 1; j++) {
														if (10 == imageType[j]) {
															imgString = imgString
																	+ "<div style='float:left;margin-top:8px; width:35px;'><img src='../html/bi/img/xiaolv.png' width="
																	+ tbImgWidth
																	+ " class='small_light'/></div>";
														} else if (20 == imageType[j]) {
															imgString = imgString
																	+ "<div style='float:left; margin-top:8px; width:35px;'><img src='../html/bi/img/xiaohuang.png' width="
																	+ tbImgWidth
																	+ " class='small_light'/></div>";
														} else if (30 == imageType[j]) {
															imgString = imgString
																	+ "<div style='float:left; margin-top:8px; width:35px;'><img src='../html/bi/img/xiaohong.png' width="
																	+ tbImgWidth
																	+ " class='small_light'/></div>";
														} else {
															imgString = imgString
																	+ "<div style='float:left;margin-top:8px; width:35px;'><img src='../html/bi/img/xiaohui.png' width="
																	+ tbImgWidth
																	+ " class='small_light'/></div>";
														}
													}
