...
function loadPageForm(str){
	...
	$.hori.ajax({
			...
			"success" : function(res) {
				...
				var url= '/doctest/'+docunid+'?editdocument';
				
				localStorage.setItem("taskConUrl",url);
				var loadurl= $.hori.getconfig().appServerHost+"view/html/"+template+".html";
