...
function gettaskList(itcode){
	var serverUrl=$.hori.getconfig().appServerHost+"view/oa/todos/doctest/genertec/persontasks.nsf/dbview?openform&view=vwgwdbshow&restricttocategory="+itcode+"&start="+pages+"&count=15";
	//alert(serverUrl);
	$.hori.ajax({
		"type":"get",
		"url":serverUrl,
...
function loadPageForm(str){
	...
	var loadurl= $.hori.getconfig().appServerHost+"viewhome/oa/getunid/doctest/genertec/persontasks.nsf/agtUrlRef?openagent&unid="+unid+"&user="+itcode;
...
<<<<<<< HEAD
				var url= 'viewhome/oa/'+template+'/doctest/'+docunid+'?editdocument&data-application=mobile';
=======
				var url= 'viewhome/oa/'+template+'/doctest/'+docunid+'?editdocument&data-application=' + $.hori.getconfig().appKey + "&data-userstore=" + localStorage.getItem("cookie_userstore");
>>>>>>> acd4bba3fcb1ee51bdedbaace03964f84831e160
