...
function gettaskList(itcode){
	...
	var serverUrl=$.hori.getconfig().appServerHost+"view/oa/todos/"+docServer+"/genertec/persontasks.nsf/dbview?openform&view=vwgwdbshow&restricttocategory="+itcode+"&start="+pages+"&count=30";
	setTimeout(function () {
		$.hori.ajax({
			"type":"get",
			"url":serverUrl,
