...
$(document).ready(function(){
	...
	alert(itcode);
	if(itcode==null){
		itcode=$.cookie("itcode");
	}
	var dataSource=$.hori.getconfig().serverBaseUrl+"viewhome/oa/todos/genertec/persontasks.nsf/dbview?openform&view=vwgwdbshow&restricttocategory="+currentUser;
	alert(dataSource);
	app.getData({
