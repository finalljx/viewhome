...
app.viewModel=function(data){
	...
	var mapping={"href":{
		...
		//	var targetURL= config.serverBaseUrl+"viewhome/html/appform.html";
			...
			var oaMsgUrl="/Produce/DigiFlowMobile.nsf/showform?openform&login&apptype=msg&appserver="+ServerName+"&appdbpath=DFMessage/dfmsg_"+"admin"+".nsf&appdocunid="+docunid;
			return oaMsgUrl;
		}
	}};
