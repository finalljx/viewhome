...
function getTaskList(){
	var url = 
	serverUrl+'view/oamobile/taskDownList/Produce/DigiFlowMobile.nsf/agGetMsgViewData?openagent&login&server='+oaMsgServer+'&dbpath=DFMessage/dfmsg_'+itcode+'.nsf&view=vwTaskDoneForMobile&thclass=&page=1&count=10';
	$.hori.ajax({
		"type":"get",
		"url":url,
...
function pullUpAction(){
	$.hori.showLoading();
	var serverUrl=$.hori.getconfig().appServerHost+'view/oamobile/taskDownList/Produce/DigiFlowMobile.nsf/agGetMsgViewData?openagent&login&server='+oaMsgServer+'&dbpath=DFMessage/dfmsg_'+itcode+'.nsf&view=vwTaskDoneForMobile&thclass=&page='+pages+'&count=10';
	setTimeout(function () {
		$.hori.ajax({
			"type":"get",
			"url":serverUrl,
